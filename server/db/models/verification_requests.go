...
type VerificationRequest struct {
	...
	Identifier  string `gorm:"uniqueIndex:idx_email_identifier;type:char(36)" json:"identifier" bson:"identifier"`
	ExpiresAt   int64  `json:"expires_at" bson:"expires_at"`
	CreatedAt   int64  `json:"created_at" bson:"created_at"`
	UpdatedAt   int64  `json:"updated_at" bson:"updated_at"`
	Email       string `gorm:"uniqueIndex:idx_email_identifier;type:char(36)" json:"email" bson:"email"`
